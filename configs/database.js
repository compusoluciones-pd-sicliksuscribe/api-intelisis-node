...
const config = {
  connectionLimit: envDatabaseVars.DB_CONNECTION_LIMIT,
  host: envDatabaseVars.DB_HOST,
  user: envDatabaseVars.DB_USER,
  password: envDatabaseVars.DB_PASSWORD,
  database: envDatabaseVars.DB_NAME,
  dateStrings: envDatabaseVars.DB_DATE_STRINGS,
  debug: envDatabaseVars.DB_DEBUG,
  showQueries: envDatabaseVars.DB_SHOW_QUERIES,
};
